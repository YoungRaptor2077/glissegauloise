          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={async (e) => {
                e.stopPropagation();
                if (!row.userId) {
                  alert("Ce client n'a pas de compte. Contactez-le par telephone ou email.");
                  return;
                }
                try {
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-blue-500/10 bg-blue-500/5 p-4">
              ...
              {selectedRepair.userId ? (
                ...
                <p className="text-xs text-blanc-casse/40">Ce client n&apos;a pas de compte. Contactez-le par telephone ou email.</p>
              )}
            </div>
